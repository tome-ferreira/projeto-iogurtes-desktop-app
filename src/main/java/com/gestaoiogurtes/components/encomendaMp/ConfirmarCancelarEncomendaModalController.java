...
/**
 * Modal de confirmação para cancelar uma encomenda de matéria prima.
 * Chama PATCH /encomendas-mp/{id}/cancelar.
 *
 ...
 */
public class ConfirmarCancelarEncomendaModalController {
    ...
    public static void show(String encomendaId,
        ...
        try {
            FXMLLoader loader = new FXMLLoader(
                    ConfirmarCancelarEncomendaModalController.class
                            .getResource("/fxml/components/encomendaMp/ConfirmarCancelarEncomendaModal.fxml"));
            ...
            ConfirmarCancelarEncomendaModalController ctrl = loader.getController();
