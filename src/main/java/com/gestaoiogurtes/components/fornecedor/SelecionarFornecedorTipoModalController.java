...
import com.gestaoiogurtes.models.fornecedor.FornecedorTipoSelecao;
...
public class SelecionarFornecedorTipoModalController {
    ...
    private Consumer<FornecedorTipoSelecao> onConfirm;
    ...
    public static void show(
            ...
            Consumer<FornecedorTipoSelecao> onConfirm) {
        try {
            FXMLLoader loader = new FXMLLoader(
                    SelecionarFornecedorTipoModalController.class
                            .getResource("/fxml/components/fornecedor/SelecionarFornecedorTipoModal.fxml"));
            ...
            stage.setTitle("Selecione o Tipo de Fornecedor");
            stage.setScene(new Scene(root));

            SelecionarFornecedorTipoModalController ctrl = loader.getController();
    ...
    private void handleContinuar() {
        if (selectedId != null && !selectedId.isBlank()) {
            onConfirm.accept(new FornecedorTipoSelecao(selectedId, selectedNome));
        }
        dialogStage.close();
    }
    ...
    private void carregarPagina(int page) {
        ...
        fornecedorService.getAllTipos(page, PAGE_SIZE, state -> {
            if (state.isLoading()) {
                setLoadingVisible(true);
    ...
    private void renderizarLista(List<FornecedorTipoResponse> tipos) {
        listaContainer.getChildren().clear();
        ...
        for (FornecedorTipoResponse tipo : tipos) {
