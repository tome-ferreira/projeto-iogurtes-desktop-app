...
public class DetalhesGestorModalController {
    ...
    public static void show(UserResponse u, boolean inativo, Window owner) {
        try {
            FXMLLoader loader = new FXMLLoader(DetalhesGestorModalController.class
                    .getResource("/fxml/components/utilizadores/DetalhesGestorModal.fxml"));
            ...
            stage.setTitle("Detalhes do Gestor");
            stage.setScene(new Scene(root));

            DetalhesGestorModalController ctrl = loader.getController();
