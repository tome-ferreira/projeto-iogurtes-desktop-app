...
public class DetalhesAdminModalController {
    ...
    public static void show(UserResponse u, boolean inativo, Window owner) {
        try {
            FXMLLoader loader = new FXMLLoader(DetalhesAdminModalController.class
                    .getResource("/fxml/components/utilizadores/DetalhesAdminModal.fxml"));
            ...
            stage.setTitle("Detalhes do Administrador");
            stage.setScene(new Scene(root));

            DetalhesAdminModalController ctrl = loader.getController();
