...
public class DetalhesFuncionarioMpModalController {
    ...
    public static void show(UserResponse u, boolean inativo, Window owner) {
        try {
            FXMLLoader loader = new FXMLLoader(DetalhesFuncionarioMpModalController.class
                    .getResource("/fxml/components/utilizadores/DetalhesFuncionarioMpModal.fxml"));
            ...
            stage.setTitle("Detalhes do Funcionário MP");
            stage.setScene(new Scene(root));

            DetalhesFuncionarioMpModalController ctrl = loader.getController();
