...
public class SelecionarMateriaPrimaComposicaoModalController {
    ...
    private Consumer<MateriaPrimaComposicaoSelecao> onConfirm;
    ...
    public static void show(
            ...
            Window owner,
            Consumer<MateriaPrimaComposicaoSelecao> onConfirm) {
        try {
            FXMLLoader loader = new FXMLLoader(
                    SelecionarMateriaPrimaComposicaoModalController.class
                            .getResource("/fxml/components/produtoFinal/SelecionarMateriaPrimaComposicaoModal.fxml"));
            ...
            SelecionarMateriaPrimaComposicaoModalController ctrl = loader.getController();
    ...
    public void initialize() {
        ...
        // Validação em tempo real: revalida estado do botão ao digitar
    ...
    private void handleAdicionar() {
        ...
        onConfirm.accept(new MateriaPrimaComposicaoSelecao(selectedId, selectedNome, quantidade));
        dialogStage.close();
    }
    ...
    private void renderizarLista(List<MateriaPrimaResponse> itens) {
        ...
        for (MateriaPrimaResponse mp : itens) {
            ...
            Runnable seleccionar = () -> {
                selectedId = id;
                selectedNome = nome;
                // Desseleccionar todos, depois marcar este
        ...
        // Re-marcar a selecção actual se ainda existir nesta página
        if (selectedId != null && !selectedId.isBlank()) {
            validarEstadoBotao();
        }
    }
